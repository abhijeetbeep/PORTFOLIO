...
import { getGraphicGalleryItems } from "@/lib/portfolio-gallery";

export const metadata: Metadata = {
  title: `Graphic Design Projects | ${personalData.logoText}`,
  description: "A premium graphic design gallery featuring posters, thumbnails, branding, and social content.",
};

export default function GraphicDesignPage() {
  const items = getGraphicGalleryItems();
